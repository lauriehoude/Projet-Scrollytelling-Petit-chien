...
chapitre2.to(".chien-courone", { y: "90vh", duration: 2, delay: 3, repeat:-1 });
chapitre2.to(".courone", { x: "30vw", duration: 3, rotate: "360", repeat:-1}, "<")

let chapitre3 = gsap.timeline();
chapitre3.to(".personnage", { x: "20vw", duration: 2, opacity: 0, scale: 1, delay: 6, repeat:-1 }, )
...
chapitre4.to(".chien-nage", { x: "100vw", duration: 1, scale: 2, repeat:-1 })
...
chapitre6.to(".chien-paradis", { y: "-10vh", duration: 1, ease: true, rotate: "-5", repeat:-1 }, "<")
chapitre6.to(".chien-paradis", { x: "10vh", duration: 2, ease: true, rotate: "10", repeat:-1 })
chapitre6.to(".chien-paradis", { y: "-15vh", duration: 2, ease: true, rotate: "-12", repeat:-1 })
